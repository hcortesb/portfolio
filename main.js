...
const ui = {
  en: {
    ...
    'nav.contact':                  'Contact',
    'nav.cta':                      'Hire Me',
    'hero.eyebrow':                 'Fashion Model',
    'hero.availability':            'Worldwide bookings',
    ...
    'hero.location':                'Barcelona, Spain based',
  ...
  es: {
    ...
    'nav.cta':                      'Contrátame',
    'hero.eyebrow':                 'Modelo de Moda',
    'hero.availability':            'Reservas internacionales',
    ...
    'hero.location':                'Con sede en Barcelona, España',
